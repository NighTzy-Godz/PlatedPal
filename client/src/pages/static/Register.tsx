        ...
        <AuthFormWidth>
          <div className="text-center mb-10">
            ...
            <p className="text-textColor text-lg leading-tight">
              In order to join communities, add and save recipes, you must
          ...
          <form onSubmit={handleSubmit(handleRegisterUserSubmit)}>
            ...
            <div className="flex gap-3 sm:flex-nowrap flex-wrap mb-5">
              <FormInputsContainer>
                ...
                <Input
                  ...
                  {...register("confirmPassword", {
                    ...
                    minLength: {
                      value: 5,
                      message:
                        "Confirm Password should be atleast 5 characters",
                    },
                  })}
                />
